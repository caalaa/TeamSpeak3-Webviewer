...
class serverInfo extends ms_Module
{
    ...
    function __construct($info, $config, $lang, $mm)
    {
        ...
        $this->html.='<!--- START Serverinfo -->
            ...
            <tr>
            <td width="33%"><h5>' . $this->lang['welcome_msg'] . '</h5><p style="border-width:1px;border-style:dotted;">' . $welcomemsg . '</p><h5>' . $this->lang['channels'] . '</h5><p><span class="channelimage normal-channel">&nbsp;</span>' . $serverinfo['virtualserver_channelsonline'] . '</p></td>
