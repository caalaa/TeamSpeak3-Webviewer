...
function createEditHtml()
{
    ...
    //$html['module_html'] = '<fieldset>';
    
    foreach($modules as $module)
    {
        $configmods = explode(",", $configfile->modules);
        if ( in_array($module, $configmods) )
                $html['module_html'] .= '<p><input type="checkbox" name="module[]" checked="checked" value="'.$module.'"/><a href="core/xmledit.php?module='.$module.'" class="color" title="Edit Config of this module">'.$module.'</a></p>';
        else
            $html['module_html'] .= '<p><input type="checkbox" name="module[]" value="'.$module.'"/><a href="core/xmledit.php?module='.$module.'" class="color" title="Edit Config of this module">'.$module.'</a></p>';
